...
SET "JAVA_HOME=%~dp0jdk\jdk-11.0.1"
...
call mvn --fail-at-end -T1C --settings=%~dp0..\mvn_user_settings.xml -f %~dp0..\base\uk.ac.stfc.isis.ibex.client.tycho.parent\pom.xml clean verify
if %errorlevel% neq 0 exit /b %errorlevel%
