...
public class SansWaitLabelProvider extends ComboCellLabelProvider {

	protected SansWaitLabelProvider(IObservableMap[] attributeMaps) {
		super(attributeMaps);
	}
	...
	public void update(final ViewerCell cell) {
		...
		checkBox.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				row.setSansWait(combo.getSelection());
			}
		});
	}
