...
public abstract class AbstractGenerator extends ModelObject {
	 ...
	 * @param scriptDefinition The instrument config to generate the script with.
	 ...
	 * @throws InterruptedException The call to generate a script was interrupted
	 */
	public abstract void refreshAreParamsValid(List<ScriptGeneratorAction> scriptGenContent, ScriptDefinitionWrapper config) throws InterruptedException, ExecutionException;
	 ...
	 * @throws InterruptedException The call to generate a script was interrupted
	 */
	public abstract void refreshValidityErrors(List<ScriptGeneratorAction> scriptGenContent, ScriptDefinitionWrapper config) throws InterruptedException, ExecutionException;
