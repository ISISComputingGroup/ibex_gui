...
public class OnInstrumentSwitch implements InstrumentInfoReceiver {
    ...
    ExperimentSetupViewModel experimentSetupViewModel = DaeUI.getDefault().viewModel().experimentSetup();
    /**
     * Updates the DaeUI on switching instrument.
     * 
     * @param instrument
    ...
    public void preSetInstrument(InstrumentInfo instrument) {
        experimentSetupViewModel.switchInstrumentCachedValues(instrument.name());
    }

    @Override
    public void postSetInstrument(InstrumentInfo instrument) {
        experimentSetupViewModel.resetChangeLabels();
    }
}
