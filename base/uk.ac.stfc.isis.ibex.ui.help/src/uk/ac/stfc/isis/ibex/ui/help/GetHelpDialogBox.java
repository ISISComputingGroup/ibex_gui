...
public class GetHelpDialogBox extends TitleAreaDialog {
     ...
     */
    public GetHelpDialogBox(Shell parentShell) {
        super(parentShell);     
    ...
    protected Control createDialogArea(Composite parent) {
        ...
        Optional<String> textBoxContents = Optional.ofNullable(getClass().getResource(GETHELP_FILE_PATH))
                .map(GetHelpDialogBox::stringFromUrl)
                .flatMap(Function.identity());
        
        txtIconLicences.setText(textBoxContents.orElse(String.format("Can't read from file '%s'", GETHELP_FILE_PATH)));
