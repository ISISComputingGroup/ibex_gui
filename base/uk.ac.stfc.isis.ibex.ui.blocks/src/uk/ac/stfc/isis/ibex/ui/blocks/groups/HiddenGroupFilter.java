...
/**
 * Utility class for filtering out groups which only contain hidden blocks.
 */
public final class HiddenGroupFilter {
    
    /**
     * Class only contains static methods, hence private constructor.
     */
    private HiddenGroupFilter() {      
    }
    
    /**
     * Filters out groups that only contain hidden blocks.
     * 
     * @param allGroups - a list of all groups
