...
public interface Displaying {
	...
	/**
	 * Returns top-level alert settings that can be displayed in a GUI.
	 * 
	 * @return top-level alert settings that can be displayed in a GUI
	 */
	TopLevelAlertSettings getTopLevelAlertSettings();
}
