...
public class ConfigServer extends Closer {
     ...
     * 
     * @param variables
     *            The class that holds all the observables to the various
     *            blockserver PVs.
     */
    ...
    /**
     * Returns an observable to the current configuration loaded on the
     * instrument.
     * 
    ...
    /**
     * Returns an observable to a blank configuration to be used when first
    ...
    /**
     * Returns an observable to the information on what components are
     * available.
     * 
     * @return the Collection<{@link ConfigInfo}> observable object
     */
    ...
    /**
     * Returns an observable to the components that are currently available on
     * the instrument.
     * 
    ...
    /**
     * Returns an observable to the information contained in the given
     * component.
     * 
     * @param componentName
    ...
    /**
     * Returns a writable to set the current configuration on the
     * instrument.<br>
     * The writable expects a Configuration with the name of the configuration
     * to load.
     * 
    ...
    /**
     * Returns a collection of the names of all the components on the
     * instrument.
     * 
     * @return the {@code Collection<String>} of configuration names
     */
    ...
    /**
     * Returns a {@link SetCommand} object that can be used to start any ioc.
     * <br>
    ...
    /**
     * Returns a {@link SetCommand} object that can be used to stop any ioc.
     * <br>
    ...
    /**
     * Returns a {@link SetCommand} object that can be used to restart any ioc.
     * <br>
     * The SetCommand expects a collection of the names of the iocs to start.
     * 
