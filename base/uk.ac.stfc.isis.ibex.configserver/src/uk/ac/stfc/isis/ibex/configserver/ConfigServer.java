...
public class ConfigServer extends Closer {
	 ...
	 * 
	 * @param variables The class that holds all the observables to the various
	 *                  blockserver PVs.
	 */
	...
	/**
	 * Returns an observable to a blank configuration to be used when first creating
	 * a configuration.
	 * 
	 * @return the {@link Configuration} observable object
	 */
	...
	/**
	 * Returns an observable to the information on what configurations are
	 * available.
	 * 
	...
	/**
	 * Returns an observable to all the pvs that have been available on the
	 * instrument.
	 * 
	...
	/**
	 * Returns an observable to the PVs that are currently available on the
	 * instrument.
	 * 
	 * @return the Collection<{@link PV}> observable object
	 */
	...
	/**
	 * Returns an observable to the components that are currently available on the
	 * instrument.
	 * 
	 ...
	 * The writable expects a Configuration with the name of the configuration to
	 * load.
	 * 
	 ...
	 * The writable expects a {@code Collection<String>} with names of the
	...
	/**
	 * Returns a collection of the names of all the configurations on the
	 * instrument.
	 * 
	 ...
	 */
	public Map<String, Boolean> configNamesWithFlags() {
		return ConfigInfo.mapNamesWithTheirProtectionFlag(configsInfo().getValue());
	}
	 ...
	 *         flags
	 */
	public Map<String, Boolean> compNamesWithFlags() {
		return ConfigInfo.mapNamesWithTheirProtectionFlag(componentsInfo().getValue());
	}
	...
	/**
	 * If a user chooses to save a configuration as a component or not then the way
	 * the config is saved will change. The following method calls or other methods
	 * that apply similar logic to choose the way a config will be saved.
	 * 
	 * @param config                     The config in which the save is being made.
	 * @param isCurrent                  True if the config being saved is the
	 *                                   current config.
	 * @param doAsComponent              True if the config being saved is to be
	 *                                   saved to a component.
	 * @param switchConfigOnSaveAs       True if the config should be switched on
	 *                                   save as.
	 * @param calledSwitchConfigOnSaveAs True if the dialog to switch config on save
	 *                                   as has been called.
	 */
	...
	private void ifIsCurrentConfigChooseSave(EditableConfiguration config, boolean isCurrent,
			boolean switchConfigOnSaveAs, boolean calledSwitchConfigOnSaveAs) {
		if (isCurrent) {
