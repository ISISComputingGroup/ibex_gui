...
public abstract class ConfigHandler<T> {
	...
	private static final Logger LOG = IsisLog.getLogger(ConfigHandler.class);
    ...
    public void onError(Exception ex) {
        LoggerUtils.logErrorWithStackTrace(LOG, "Exception while executing configserver command", ex);
