...
public class EditConfigDialog extends TitleAreaDialog implements MessageDisplayer {
	...
	protected void createButtonsForButtonBar(Composite parent) {
		...
		saveAsBtn.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				...
				Collection<String> componentNames = Configurations.getInstance().server().componentNames();
