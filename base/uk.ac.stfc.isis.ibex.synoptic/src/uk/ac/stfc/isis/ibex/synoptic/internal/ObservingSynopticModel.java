...
public class ObservingSynopticModel {
	...
	InitialiseOnSubscribeObservable<SynopticDescription> synopticDescriptionObservable = variables
		.getSynopticDescription(newSynoptic.pv());

	UpdatedValue<SynopticDescription> config = new UpdatedObservableAdapter<>(
		synopticDescriptionObservable);
