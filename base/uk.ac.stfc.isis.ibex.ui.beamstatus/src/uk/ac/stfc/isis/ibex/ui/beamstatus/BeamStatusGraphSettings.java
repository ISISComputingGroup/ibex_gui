 ...
 * changed.
 */
public class BeamStatusGraphSettings implements InstrumentInfoReceiver {

    private IPreferenceStore preferences;

    public BeamStatusGraphSettings() {
        this(Activator.getDefault().getPreferenceStore());
    }

    public BeamStatusGraphSettings(IPreferenceStore preferences) {
