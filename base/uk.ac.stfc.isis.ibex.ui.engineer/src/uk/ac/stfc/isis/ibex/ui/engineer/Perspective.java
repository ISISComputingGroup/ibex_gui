...
/**
 * The perspective giving an engineering view.
 */
public class Perspective extends BasePerspective {
	@Override
	public String id() {
        return "uk.ac.stfc.isis.ibex.ui.engineer.perspective";
	}
	...
	@Override
	public Image image() {
        return ResourceManager.getPluginImage("uk.ac.stfc.isis.ibex.ui.motor", "icons/gears6_32x24.png");
