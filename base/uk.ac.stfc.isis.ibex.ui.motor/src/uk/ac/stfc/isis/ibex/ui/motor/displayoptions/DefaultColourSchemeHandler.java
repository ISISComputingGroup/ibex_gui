 ...
 */
public class DefaultColourSchemeHandler {
    
    private MHandledMenuItem menuItem;
	
    @Execute
    public Object execute(MHandledMenuItem menuItem, Shell shell) throws ExecutionException {
    	...
    	if (menuItem.isSelected()) {
            ...
            for (IViewReference viewReference : viewReferences) {
                ...
                if (viewPart instanceof TableOfMotorsView) {
                	System.out.println("default: some stuff");
