...
public class LogMessageQuery {
    private static final LogMessageFieldsSql[] SQL_SELECT_FIELDS = {
	    ...
	    LogMessageFieldsSql.TYPE, LogMessageFieldsSql.CONTENTS,
	    LogMessageFieldsSql.CLIENT_NAME, LogMessageFieldsSql.SEVERITY,
	    LogMessageFieldsSql.CLIENT_HOST, LogMessageFieldsSql.APPLICATION_ID };
    ...
    /**
     * Performs a database search, returning all log messages in the DB that
     * match the request parameters.
     * 
     * @param searchField
     *            The log message field to search by.
     * @param searchValue
     *            Search the 'searchField' field of every record for this string
     *            value
     * @param from
     *            Consider only messages that occurred after this time (null =
     *            no limit).
     * @param to
    ...
    /**
     * Performs a database search, returning all log messages in the DB that
     * match the request parameters. Converts the LogMessageField to the
     * appropriate LogMessageFieldSql to allow for a schema change
     * 
     * @param searchField
     *            The log message field to search by.
     * @param searchValue
