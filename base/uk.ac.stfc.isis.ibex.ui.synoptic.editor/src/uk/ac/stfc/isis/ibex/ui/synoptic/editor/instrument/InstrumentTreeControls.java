...
public class InstrumentTreeControls extends Composite {
    ...
    /**
     * Control for the components tree on the synoptic.
     * @param parent parent on control
     * @param synopticViewModel view model for this synoptic
     */
    @SuppressWarnings("checkstyle:magicnumber")
    public InstrumentTreeControls(Composite parent, SynopticViewModel synopticViewModel) {
    ...
    /**
     * Refresh the control value on the page if needed.
     */
    public void refresh() {
	btnShowBeam.setSelection(synopticViewModel.getShowBeam());
    }
