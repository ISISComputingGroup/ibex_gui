...
public final class LoggerUtils {
	...
	private static final Logger LOGGERUTILS_LOGGER = IsisLog.getLogger(LoggerUtils.class);
    ...
    static {
    	LOGGERUTILS_LOGGER.info("Extra debugging information is " + (EXTRA_DEBUG ? "ENABLED" : "DISABLED"));
    }
    ...
    public static void logErrorWithStackTrace(Logger log, String message, Throwable e) {
        ...
        if (e.getCause() != null) {
        	logErrorWithStackTrace(log, "Caused by: ", e.getCause());
        }
    }
